...
namespace EverestAlbumLibrary.Controllers
{
    public class LoansController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,IssuedDate,ReturnedDate,CopyNumber,MemberId,AlbumId")] Loan loan)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,IssuedDate,ReturnedDate,CopyNumber,MemberId,AlbumId")] Loan loan)
        {
            if (ModelState.IsValid)
            {
